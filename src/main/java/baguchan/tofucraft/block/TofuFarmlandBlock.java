...
public class TofuFarmlandBlock extends Block {
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		return !this.getDefaultState().isValidPosition(context.getWorld(), context.getPos()) ? TofuBlocks.TOFU_TERRAIN.getDefaultState() : super.getStateForPlacement(context);
	}
	...
	public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
		if (!worldIn.isRemote && net.minecraftforge.common.ForgeHooks.onFarmlandTrample(worldIn, pos, TofuBlocks.TOFU_TERRAIN.getDefaultState(), fallDistance, entityIn)) { // Forge: Move logic to Entity#canTrample
	...
	public static void turnToDirt(BlockState state, World worldIn, BlockPos pos) {
		worldIn.setBlockState(pos, nudgeEntitiesWithNewState(state, TofuBlocks.TOFU_TERRAIN.getDefaultState(), worldIn, pos));
	}
