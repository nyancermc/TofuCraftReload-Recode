...
public class TofuBedBlockRenderer extends TileEntityRenderer<TofuBedTileEntity> {
	...
	public void render(TofuBedTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
		...
		if (world != null) {
			...
			TileEntityMerger.ICallbackWrapper<? extends TofuBedTileEntity> icallbackwrapper = TileEntityMerger.combineWithNeigbour(TofuTileEntitys.TOFUBED, BedBlock::getBlockType, BedBlock::getConnectedDirection, ChestBlock.FACING, blockstate, world, p_225616_1_.getBlockPos(), (p_228846_0_, p_228846_1_) -> {
				return false;
			});
