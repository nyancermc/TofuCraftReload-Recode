	...
	private boolean func_221245_b() {
		...
		if (playerentity == null) {
			...
			if (blockpos2 != null && this.func_226559_a_(blockpos2)) {
				...
				TravelerTofunianEntity entityTravelerTofunian = (TravelerTofunianEntity) TofuEntityTypes.TRAVELER_TOFUNIAN.spawn(this.world, (CompoundNBT) null, (ITextComponent) null, (PlayerEntity) null, blockpos2, SpawnReason.EVENT, false, false);
