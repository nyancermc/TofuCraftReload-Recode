...
/*    @Nullable
	...
	protected net.minecraftforge.fluids.FluidAttributes createAttributes() {
		return net.minecraftforge.fluids.FluidAttributes.builder(
				new net.minecraft.util.ResourceLocation(TofuCraftReload.MODID, "blocks/soymilk_hell"),
				new net.minecraft.util.ResourceLocation(TofuCraftReload.MODID, "blocks/soymilk_hell_flow")).build(this);
	}
