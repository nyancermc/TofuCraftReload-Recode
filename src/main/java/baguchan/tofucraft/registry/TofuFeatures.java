...
public class TofuFeatures {
	...
	public static final Feature<NoFeatureConfig> ZUNDA_MUSHROOM_SMALL = new SurfaceTofuTemplateFeature(NoFeatureConfig.CODEC, 7, 7, new ResourceLocation[]{new ResourceLocation(TofuCraftReload.MODID, "mushroom/mushroom_zunda_small"), new ResourceLocation(TofuCraftReload.MODID, "mushroom/mushroom_zunda_cache_small")});
	public static final Feature<NoFeatureConfig> ZUNDA_MUSHROOM_BIG = new SurfaceTofuTemplateFeature(NoFeatureConfig.CODEC, 7, 7, new ResourceLocation[]{new ResourceLocation(TofuCraftReload.MODID, "mushroom/mushroom_zunda_big"), new ResourceLocation(TofuCraftReload.MODID, "mushroom/mushroom_zunda_big2")});
